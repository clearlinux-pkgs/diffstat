...
Source0  : https://invisible-mirror.net/archives/diffstat/diffstat-1.68.tgz
Source1  : https://invisible-mirror.net/archives/diffstat/diffstat-1.68.tgz.asc
...
%setup -q -n diffstat-1.68
cd %{_builddir}/diffstat-1.68
pushd ..
cp -a diffstat-1.68 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745598656
