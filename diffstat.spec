...
Source0  : https://invisible-mirror.net/archives/diffstat/diffstat-1.66.tgz
Source1  : https://invisible-mirror.net/archives/diffstat/diffstat-1.66.tgz.asc
...
%prep
%setup -q -n diffstat-1.66
cd %{_builddir}/diffstat-1.66
pushd ..
cp -a diffstat-1.66 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706541495
